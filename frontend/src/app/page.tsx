  ...
  useEffect(() => {
    getStatus()
      .then(async (status) => {
        ...
        if (me?.ok && me.user) {
          // Land on the dashboard like fastclaw — users pick (or create)
          // their own agent from /agents/ instead of being dropped into
          // the seeded super_admin-owned "default" agent.
